...
ActiveRecord::Schema.define(version: 20170308230823) do
  ...
  create_table "assigned_players", force: :cascade do |t|
    t.integer  "scout_id"
    t.integer  "player_id"
    t.string   "name"
    t.datetime "created_at"
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.integer  "assigned_to_a_scout_count"
    t.integer  "is_favorited_by_scout_count"
  end
  ...
  create_table "scouts", force: :cascade do |t|
    ...
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
    t.integer  "assigned_players_count"
